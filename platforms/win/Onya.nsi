...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Onya"
...
SetOutPath "$INSTDIR"
File "D:\DEV\apps\OnyaNew\onya.exe"
SectionEnd
...
CreateDirectory "$SMPROGRAMS\Onya"
CreateShortCut "$SMPROGRAMS\Onya\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\Onya\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Onya\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Onya\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\Onya\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Onya\${APP_NAME} Website.lnk"
!endif
RmDir "$SMPROGRAMS\Onya"
!endif
